...
#    model = load_model('Models/video.h5')
    model = load_model('/Users/yvesfogel/Downloads/Multimodal-Emotion-Recognition-master/Models/video.h5')
    face_detect = dlib.get_frontal_face_detector()
    predictor_landmarks  = dlib.shape_predictor("/Users/yvesfogel/Downloads/Multimodal-Emotion-Recognition-master/Models/face_landmarks.dat")
    ...
    #out = cv2.VideoWriter("/Users/yvesfogel/Desktop/result.mp4", fourcc, 20.0, (1080, 1920), 1)
    ...
    while True:
        ...
        for (i, rect) in enumerate(rects):
            ...
            if prediction_result == 0 :
                cv2.putText(frame, "Angry",(x+w-10,y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, 127, 2)
            elif prediction_result == 1 :
                cv2.putText(frame, "Disgust",(x+w-10,y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, 127, 2)
            elif prediction_result == 2 :
                cv2.putText(frame, "Fear",(x+w-10,y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, 127, 2)
            elif prediction_result == 3 :
                cv2.putText(frame, "Happy",(x+w-10,y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, 127, 2)
            elif prediction_result == 4 :
                cv2.putText(frame, "Sad",(x+w-10,y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, 127, 2)
            elif prediction_result == 5 :
                cv2.putText(frame, "Surprise",(x+w-10,y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, 127, 2)
            else :
                cv2.putText(frame, "Neutral",(x+w-10,y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, 127, 2)
